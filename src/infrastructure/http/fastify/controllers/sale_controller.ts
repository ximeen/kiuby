...
import { getCustomerRepository, getProductsRepository, getSaleRepository, getStockMovementRepository, getStockRepository } from "@shared/container/repositories";
import { FastifyReply, FastifyRequest } from "fastify";
import { number, object, string, uuid, enum as enum_, array, httpUrl } from "zod";
...
const createSaleSchema = object({
    ...
    paymentMethod: enum_(["cash", "credit_card", "debit_card", "pix", "bank_slip", "credit"]).optional(),
